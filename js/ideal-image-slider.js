	...
	var Slider = function(args) {
		...
		if (!this.settings.disableNav) {
			...
			if (('ontouchstart' in window) || window.DocumentTouch && document instanceof DocumentTouch) {
				...
				previousNav.style.display = 'true';
				nextNav.style.display = 'true';
				_addClass(sliderEl, this.settings.classes.touchEnabled);

				_addEvent(sliderEl, 'touchstart', _touch.start.bind(this), true);
				_addEvent(sliderEl, 'onmousemove', _touch.move.bind(this), true);
				_addEvent(sliderEl, 'touchend', _touch.end.bind(this), true);
			}
